...
public class Divider extends RecyclerView.ItemDecoration {
     ...
     * @return
     */
    public static Divider getDefaultDividerItemDecoration() {
     ...
     * @return
     */
    public static Divider transparentDivider(int height) {
        Divider divider = new Divider(new ColorDrawable(Color.TRANSPARENT), OrientationHelper.VERTICAL);
     ...
     * @return
     */
    public static Divider defaultDivider() {
        Divider divider = new Divider(new ColorDrawable(Color.parseColor("#d9d9d9")), OrientationHelper.VERTICAL);
        divider.setHeight(1);
