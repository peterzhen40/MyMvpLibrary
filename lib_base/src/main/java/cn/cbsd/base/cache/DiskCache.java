...
import cn.cbsd.base.utils.CodecKit;
...
public class DiskCache implements ICache {
    ...
    private DiskCache(Context context) {
        ...
        try {
            ...
            cache = DiskLruCache.open(cacheDir, CommonKit.getVersionCode(context), 1, 10 * 1024 * 1024);        //10M
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static String getMd5Key(String key) {
        return CodecKit.MD5.getMessageDigest(key.getBytes());
    }
