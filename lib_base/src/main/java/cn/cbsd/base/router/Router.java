...
public class Router {
    ...
    public static Router newIntent(Fragment context) {
        Router router = new Router();
    ...
    public Router fromFragment(Fragment fromFragment) {
    ...
    public Router putStringArray(@Nullable String key, @Nullable String[] value) {
        getBundleData().putStringArray(key, value);
        return this;
    }
